...
//this is the logic to retirieve the pizza-id from the URL and make a GET request for the associated pizza!
function getPizza() {
  //get if of pizza
  ...
  fetch(`/api/pizzas/${pizzaId}`)
    ...
    .catch((err) => {
      console.log(err);
      alert("Cannot find a 🍕 with this id! Taking you back.");
      window.history.back();
    });
}
